...
n, m, r = 5, 5, 4
mapping = {1: 5, 2: 7, 3: 8, 4: 2, 5: 3}
graph = {1: [(4, 5), (2, 3)], 4: [(1, 5)], 5: [(2, 4)], 2: [(5, 4), (3, 3), (1, 3)], 3: [(2, 3)]}
...
mapping = {idx: value for idx, value in enumerate(list(map(int, input().split())), 1)}
