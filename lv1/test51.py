...
# 1번 폰켓몬 한 마리, 2번 폰켓몬 한 마리가 있음을 나타냅니다. 이때, 
...
# 설명 엄청 어렵게 한거같은데 이쯤되면 코테가 아니라 독해문제같음
# num길이를 알고있어야 함
n = len(nums)//2
# nums를 중복제거하고
n_set = len(set(nums))
# n_set과 n을 비교해서 더 작은걸 리턴
if n_set>=n: answer = n
else: answer = n_set
